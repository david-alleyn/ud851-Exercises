...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String RESULTS_JSON_KEY = "ResultsJsonKey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(QUERY_URL_KEY)){
                String urlTextView = savedInstanceState.getString(QUERY_URL_KEY);
                mUrlDisplayTextView.setText(urlTextView);
            }

            if(savedInstanceState.containsKey(RESULTS_JSON_KEY)) {
                String resultsTextView = savedInstanceState.getString(RESULTS_JSON_KEY);
                mSearchResultsTextView.setText(resultsTextView);
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(QUERY_URL_KEY, urlTextView);

        String resultsTextView = mSearchResultsTextView.getText().toString();
        outState.putString(RESULTS_JSON_KEY, resultsTextView);
    }
